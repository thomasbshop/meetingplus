"""
Django settings for meetingplus project.
...
SECRET_KEY = 'django-insecure-_#luv^a^w317ow86h)43j*k4-i5um^0wxplsr5y+#of5g*gsbp'
...
ROOT_URLCONF = 'meetingplus.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "meetingplus", "templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
