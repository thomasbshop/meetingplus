...
class MeetingChatRoomAdmin(admin.ModelAdmin):
...
admin.site.register(MeetingChatRoom, MeetingChatRoomAdmin)
...
class MeetingRoomChatMessageAdmin(admin.ModelAdmin):
    ...
    class Meta:
        model = MeetingRoomChatMessage


admin.site.register(MeetingRoomChatMessage, MeetingRoomChatMessageAdmin)